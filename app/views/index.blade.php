...
@section('content')
    ...
    <div class="row" data-equalizer>
        <div class="large-3 columns">
            <div class="panel home-page-widget-panels" data-equalizer-watch>
                <h5>
        ...
        @if(Employee::projectChecker("event360"))
            <div class="large-3 columns">
                <div class="panel home-page-widget-panels" data-equalizer-watch>
                    <h5>
                        Event360 Online Leads (Last 5 Weeks)
                    </h5>
            ...
            <div class="large-3 columns">
                <div class="panel home-page-widget-panels" data-equalizer-watch>
                    <h5>
                        Event360 Message Leads (Last 5 Weeks)
                    </h5>
        ...
        @else
            ...
            $pull_calls_back = "large-pull-6";

            ?>

        @endif

        <div class="large-3 columns {{ $pull_calls_back }}">
            <div class="panel home-page-widget-panels" data-equalizer-watch>
                <h5>
                    Call Leads (Last 5 Weeks)
                </h5>
        ...
        <div class="row">
            <div class="large-12 columns">
                <ul class="tabs" data-tab>
                    <li class="tab-title active"><a href="#panel-event360-enquiries">Event360 Online Leads</a></li>
                    <li class="tab-title"><a href="#panel-event360-messages">Event360 Messages</a></li>
                </ul>
