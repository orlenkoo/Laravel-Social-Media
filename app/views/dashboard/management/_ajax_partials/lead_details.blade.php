...
<div class="row" style="margin-top: 20px;">
    <div class="large-12 columns">
        ...
        <ul class="tabs" data-tabs id="tabs_lead_details_{{ $lead->id }}">
            <li class="tabs-title is-active"><a href="#panel_lead_details_{{ $lead->id }}" aria-selected="true">Lead Details</a></li>
            <li class="tabs-title"><a href="#panel_lead_time_line_{{ $lead->id }}" onclick="ajaxLoadDashboardLeadTimeLine(1)">Lead Time Line</a></li>
            <li class="tabs-title"><a href="#panel_notes_{{ $lead->id }}" aria-selected="true" onclick="ajaxLoadDashboardLeadNotesList(1)">Lead Notes</a></li>
            @if(is_object($lead->customer))
        ...
        <div class="tabs-content" data-tabs-content="tabs_lead_details_{{ $lead->id }}">
